                ...
                <tbody>
                  ...
                  <?php foreach ($kelas as $k) :?>
                    <tr>
                        <td><?=$i?></td>
                        <td><?=$k['kelas'];?></td>
                        <td class="status-cell" data-id="<?=$k['is_active'];?>">
                            <?php
                                $label = ($k['is_active'] == 1 ? 'success' : 'danger');
                                $status = ($k['is_active'] == 1 ? 'Aktif' : 'Tidak Aktif');
                            ?>
                            <span class="status-badge badge badge-<?= $label; ?>"><?= $status; ?></span>
                        </td>
                          </td>
                        <td><?=$k['wali_kelas'];?></td>
                        <td align="center">
