...
<html lang="en">
  <head>
    ...
    <title>SMA Negeri 1 Purwodadi</title>
  </head>
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
      <div class="container">
        <a class="navbar-brand" href="#">SMA Negeri 1 Purwodadi</a>
    ...
    <div class="container">
      ...
      <div class="row justify-content-center">
        <div class="col-10 info-panel">
          <div class="row">
            <div class="col-sm">
              <img src="<?=base_url('assets/');?>img/book.png" alt="Employee" style="width: 120px;" class="img-fluid mr-2 mt-3 float-left">
              <h4>Berbudi Pekerti Luhur</h4>
              <p>Berbudi Luhur dan berprestasi unggul.</p>
            </div>
            <div class="col-lg">
